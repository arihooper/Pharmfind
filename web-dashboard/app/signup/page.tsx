...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      // simulation of signup now the API not have signup yet
      ...
      // Redirect to dashboard or confirmation(home) page
  ...
  return (
    <div className="bg-white min-h-screen flex items-center justify-center p-4">
      <div className="bg-white border border-[rgba(224,224,224,0.01)] rounded-[12px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.1)] w-full max-w-[400px] p-8 md:p-12">
        {/* logo */}
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#4caf50] hover:bg-[#45a049] transition-colors rounded-[50px] h-[52px] flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed mt-6"
          >
            {loading ? (
        ...
        <div className="mt-6 text-center">
          <p className="text-[14px] font-normal text-[#333]">
            ...
            <Link 
              href="/login" 
              className="font-bold text-[#2196f3] hover:underline transition-colors"
            >
              Login here
            </Link>
          </p>
        ...
        <div className="mt-8 pt-6 border-t border-[#e0e0e0] text-center">
          ...
          <div className="text-xs text-[#888]">
            <p>Contact support: <span className="font-medium">support@pharmfind.com</span></p>
            <p>Phone: <span className="font-medium">+2519......</span></p>
          </div>
        </div>
      </div>
    </div>
